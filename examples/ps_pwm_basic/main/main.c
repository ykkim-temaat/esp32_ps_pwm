...
void mcpwm_example_ps_pwm(void *arg)
{
    ...
    while (1) {
        ...
        // 3. Cycle Frequency and Duty every ~5 seconds (500 * 10ms)
        if (loop_counter % 500 == 0) {
            if (is_output_enabled) {
                ...
                // If output is disabled, ensure the LED is off and print idle status
...
void app_main(void)
{
    printf("Starting Basic PS-PWM Example (100kHz/200kHz Duty Sweep)...\n");
